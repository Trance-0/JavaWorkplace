...
public class Point implements Comparable<Point> {
	...
	private static class slope_Order implements Comparator<Point> {
		...
		public int compare(Point arg0, Point arg1) {
			...
			if (arg0 == null || arg1 == null) {
				...
				if (Ori.slopeTo(arg0) < Ori.slopeTo(arg1)) {
					return -1;
				} else if (Ori.slopeTo(arg0) == Ori.slopeTo(arg1)) {
					return 0;
				} else {
					return 1;
				}
	...
	public static void main(String[] args) {
		/* YOUR CODE HERE */
		Point a = new Point(229, 69);
		Point b = new Point(229, 397);
		Point c = new Point(377, 43);
		a.draw();
		a.drawTo(b);
